...
INSERT INTO `barman` (`id_barman`, `nombre`, `apellido`, `edad`, `descripcion`, `imgs`) VALUES
(1, 'Juan ', 'Gonzales', '1995-07-06', 'Trabajo de noche, vivo de dia mi especialidad es el Mojito cubano.', 'juan.png'),
(2, 'Roman', 'Perez', '1999-07-15', 'Gane varios premios de coctel como Pingüinos con mi trago especial Shakabum ', 'roman.png'),
(3, 'Juana', 'Ivanov', '1999-07-15', 'Me gustan los gatos y los tragos con alcohol, tengo sangre en vodka', 'juana.png'),
(4, 'Esteban', 'Quito', '1994-09-05', 'Trabajé muchos años en un salón de fiestas. Mi especialidad es el coctel Bloody Mary.', 'esteban.png'),
(5, 'Florencia', 'Almirante', '1984-09-15', ' Amor por el Manhattan y por Manhattan ', 'florencia.png'),
(6, 'Juan', 'Floringo', '1978-06-26', 'Barman de boliche, Siempre arriba, Siempre de fiesta, ', 'juan2.png'),
(7, 'Julio ', 'Cesar', '1990-11-11', 'Pasé 6 años trabajando los fines de semana en \"Vox\". Mis tragos predilectos son la White Lady y el Mojito.', 'julio.png'),
(8, 'Maximo', 'Fernandez', '0000-00-00', 'El amor por el whisky es algo que crece en mi dia a dia', 'maximo.png'),
(9, 'John', 'Oliver', '1988-12-31', 'Creador del el gran trago \"Solo se vive una vez\" es todo lo que necesitas para tener una gran noche', 'john.png'),
(10, 'Margarita', 'Amarga', '0000-00-00', 'Pasé los ultimos años de mi vida viviendo de noche y durmiendo de día. Viajé por le mundo siendo parte del staff de \"Glamour Model\" preparando bebidas como Mai Tai y  Manhattan.', 'margarita.png');
